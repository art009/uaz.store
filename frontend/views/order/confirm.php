    ...
    <div class="pull-right">
        ...
        <?php if (!$confirmForm->isLegal): ?>
            <?php echo $form->field($confirmForm, 'passportSeries', [
                ...
                'options' => [
                    'class' => 'form-control',
                    'placeholder' => $confirmForm->getAttributeLabel('passportSeries'),
                ],
                'clientOptions' => [
                    'clearIncomplete' => false
                ],
            ...
            <?php echo $form->field($confirmForm, 'passportNumber', [
                'template' => '{input}{error}{hint}'
            ])->widget(MaskedInput::className(), [
                'mask' => '999999',
                'options' => [
                    'class' => 'form-control',
                    'placeholder' => $confirmForm->getAttributeLabel('passportNumber'),
                ],
                'clientOptions' => [
                    'clearIncomplete' => false
                ],
