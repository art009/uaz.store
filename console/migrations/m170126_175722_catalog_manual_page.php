...
class m170126_175722_catalog_manual_page extends Migration
{
	public function up()
	{
		$this->createTable('catalog_manual_page', [
			...
			'description' => $this->text()->null()->comment('Текст для страницы'),
		...
		$this->addForeignKey('parent_manual', 'catalog_manual_page', 'manual_id', 'catalog_manual', 'id', 'CASCADE', 'CASCADE');
		$this->addForeignKey('parent_manual_category', 'catalog_manual_page', 'category_id', 'catalog_category', 'id', 'CASCADE', 'CASCADE');
	}

	public function down()
	{
		$this->dropTable('catalog_manual_page');
	}
}
