...
class m170204_150603_user extends Migration
{
    public function up()
    {
		...
		$this->createTable('user', [
			...
			'passport_number' => $this->smallInteger()->notNull()->unsigned()->defaultValue(0)->comment('Номер паспорта'),
			...
			'postcode' => $this->smallInteger()->notNull()->unsigned()->defaultValue(0)->comment('Почтовый индекс'),
